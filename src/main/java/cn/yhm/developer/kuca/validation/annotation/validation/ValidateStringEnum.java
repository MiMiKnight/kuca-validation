...
import cn.yhm.developer.kuca.validation.validator.StringEnumValidator;
...
public @interface ValidateStringEnum {
     ...
     * @return {@link String}
     */
    String message() default "{cn.yhm.developer.kuca.validation.annotation.StringEnumValid.message}";
