...
import cn.yhm.developer.kuca.validation.validator.NotNullValidator;
...
public @interface ValidateNotNull {
     ...
     * @return {@link String}
     */
    String message() default "{cn.yhm.developer.kuca.validation.annotation.NotNullValid.message}";
